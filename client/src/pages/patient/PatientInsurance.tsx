                ...
                <Card key={connection.id} data-testid={`card-connection-${connection.id}`}>
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-semibold">${parseFloat(connection.coverageLimit || 0).toLocaleString()}</span>
                    </div>
                    <div>
                    ...
                    >
                      ...
                      Pay Monthly Fee (${parseFloat(connection.monthlyFee || 0).toFixed(2)})
                    </Button>
                  </CardContent>
                </Card>
              ))}
              ...
              {availableProviders.map((provider: any) => (
                <Card key={provider.id} className="hover-elevate" data-testid={`card-provider-${provider.id}`}>
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-muted-foreground">Monthly Fee</span>
                      <span className="font-semibold text-primary">${parseFloat(provider.monthlyFee || 0).toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-muted-foreground">Coverage Limit</span>
                      <span className="font-semibold text-primary">${parseFloat(provider.coverageLimit || 0).toLocaleString()}</span>
                    </div>
                    <div>
                      <p className="text-sm text-muted-foreground mb-2">Coverage Types</p>
                      <div className="flex flex-wrap gap-1">
